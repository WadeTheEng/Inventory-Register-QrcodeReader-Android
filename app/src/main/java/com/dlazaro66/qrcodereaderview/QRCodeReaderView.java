...
public class QRCodeReaderView extends SurfaceView
  ...
  private ByteArrayOutputStream imageCopy;
  ...
  public QRCodeReaderView(Context context, AttributeSet attrs) {
    ...
    System.out.println("QRCodeReaderView");
    if (isInEditMode()) {
      return;
    }
  ...
  //mcook - retrieve the compressed image
  public ByteArrayOutputStream getImage() {
      //returning imageCopy to caller
      return imageCopy;
  }
  ...
  @Override public void onPreviewFrame(byte[] data, Camera camera) {
    ...
    //make a copy of the compressed image
    imageCopy = baos;
